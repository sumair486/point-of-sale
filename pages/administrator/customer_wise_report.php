...
<!--                 <div class="col-md-2">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select id="customerId" onchange="ajaxCall()" class="form-control select2" required>
                    	<option>Select Customer</option>
                      <?php
                      $run_items = mysqli_query($connection, "SELECT c.id, c.name FROM customer AS c ORDER BY c.name");
