...
// Customer Payment Date Wise Report
if (isset($_POST['customerId'])) {
  $customerId = $_POST['customerId'];
?>
<?php
   $select1 = "SELECT SUM(cl.credit) AS sumCreidt,SUM(cl.debit) AS sumDebit,cus.name,cus.mobile,cus.address FROM customer_ledger AS cl LEFT JOIN customer AS cus ON cus.id = cl.customer_id  WHERE cl.customer_id = '$customerId'";
        ...
        <input type="hidden" id="supId" value="<?php echo $customerId ?>">
            ...
            <div class="table-responsive" style="overflow-x:hidden !important;">
              <table class="table table-striped text-center table-bordered table-hover datatable my-only-div-shadow" id="export_table" data-page-length="10000000">
                ...
                <tbody class="table-font-size">
                  ...
                  $sumcredit = 0;
                  $sumdebit = 0;
                  $select1 = "SELECT cl.Ldate,cl.details,cl.debit,cl.credit,SUM(c.credit - c.debit) AS Balance
                  FROM customer_ledger cl,
               customer_ledger c    
              WHERE c.id <= cl.id AND c.customer_id = '$customerId' AND cl.customer_id = '$customerId' GROUP BY cl.id,cl.debit, cl.credit";
                  $run1 = mysqli_query($connection, $select1);
...
<script type="text/javascript">
       $('#export_table').dataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Customer Payment_report Excel',
                    ...
                    {
                        extend: 'pdfHtml5',
                        title: 'Customer Payment_report PDF',
                        text: 'Export to PDF',
