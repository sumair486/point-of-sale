            ...
            <section class="content">
              <div class="row">
                <div class="col-md-12 text-center">
                  <h3>Stock Report Specific Products</h3>
                </div>
              </div>
              <hr>
              <div class="row">
...
<script type="text/javascript">
  ...
  function export_all() {
    ...
    $("#export_table").tableHTMLExport({
      type: 'csv',
      filename: 'Stock Report_' + Math.floor((Math.random() * 10000000) + 1) + '.csv',
    });
